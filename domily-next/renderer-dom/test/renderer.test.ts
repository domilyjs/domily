...
import { freezeDocument, type Document } from '@domily/next-ast';
import { DocumentRuntime } from '@domily/next-runtime';
import { createMvpDomRegistry, DomRenderer, DomRendererError } from '../src/index.ts';

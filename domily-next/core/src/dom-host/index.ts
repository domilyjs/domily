import { freezeDocument, type CodecIssue, type CodecRegistry } from '../codec/index.ts';
...
import { validateDocument, type ValidationResult } from '../validator/index.ts';

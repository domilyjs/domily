...
export type ExpressionOperator = 'add' | 'and' | 'coalesce' | 'concat' | 'div' | 'empty' | 'eq' | 'get' | 'gt' | 'gte' | 'lt' | 'lte' | 'mul' | 'neq' | 'not' | 'or' | 'sub' | 'ternary';
...
export type ActionNode = CallActionNode | IfActionNode | MergeActionNode | RunActionNode | SetActionNode | ToggleActionNode | TryActionNode;
...
export declare function freezeDocument(document: Document): Document;

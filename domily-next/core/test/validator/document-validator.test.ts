...
import { createMvpHtmlRegistry, validateDocument } from '../../src/validator/index.ts';

const fixture = await Bun.file(new URL('../compiler/fixtures/todo.dmy.ts', import.meta.url)).text();

function parseFixture() {
  const parsed = compileAuthorModule(fixture);
  if (!parsed.ok) {
